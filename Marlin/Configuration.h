 ...
 *   PRUSA_MMU3           : Průša MMU3  (Requires MK3S extruder with motion sensor, EXTRUDERS = 5)
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 125.41
  #define DEFAULT_bedKi  24.49
  #define DEFAULT_bedKd 428.08
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 200, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30.500, -30.000, -2.95 }

...
static const char MSG_PROGRESS_RETURN_SELECTOR[] PROGMEM  = ISTR("Returning selector"); ////MSG_PROGRESS_RETURN_SELECTOR c=20
...
static const char MSG_PROGRESS_RETRACT_FINDA[] PROGMEM    = ISTR("Retract from FINDA"); ////MSG_PROGRESS_RETRACT_FINDA c=20

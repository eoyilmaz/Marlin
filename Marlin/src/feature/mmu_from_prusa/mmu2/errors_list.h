...
static constexpr char MSG_DESC_FW_UPDATE_NEEDED[] PROGMEM = ISTR("MMU FW version is incompatible with printer FW.Update to version 3.0.1."); ////MSG_DESC_FW_UPDATE_NEEDED c=20 r=8
